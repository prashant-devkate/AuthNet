        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Books and Stationery", "Books" }
                });

            migrationBuilder.InsertData(
                table: "Suppliers",
                columns: new[] { "SupplierId", "Address", "CompanyName", "ContactName", "Phone" },
                values: new object[,]
                {
                    { 1, "NYC", "Tech Supplies Inc", "Alice", "111-111" },
                    { 2, "LA", "BookMart", "Bob", "222-222" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedAt", "PasswordHash", "Role", "Username" },
                values: new object[] { 1, new DateTime(2025, 7, 10, 12, 20, 28, 850, DateTimeKind.Utc).AddTicks(546), "hashed-password", "Admin", "admin" });
